...
- [X] Стриминг **запроса**: `WebSocket /v1/audio/stream` ([ревизия плана](docs/plans/streaming-and-vad.md))
  ...
  - Swagger: `GET /v1/audio/stream` отдаёт протокол машиночитаемо и документирует его на /docs (тег Streaming, с рабочим примером на Python) — WebSocket в OpenAPI не попадает.
